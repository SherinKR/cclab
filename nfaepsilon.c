...
void Display_closure(int states,int closure_ar[],char *closure_table[],char *NFA_TABLE[][symbols+1],char *DFA_TABLES[][symbols])
{
	int i;
	for(i=0;i<states;i++)
	{
		...
		if(strcmp(&NFA_TABLE[i][symbols],"-")!=0)
		{
			...
			int z=closure(closure_ar,buffer);
			while(z!=100)
			{
